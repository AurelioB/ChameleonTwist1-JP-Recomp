...
Java_io_github_chameleontwist1recomp_ChameleonTwist1SDLActivity_nativeOnRomSelected(JNIEnv*, jclass, jstring) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_chameleontwist1recomp_ChameleonTwist1SDLActivity_nativeOnModsSelected(JNIEnv*, jclass, jobjectArray) {
}
#endif
...
#endif
    window = SDL_CreateWindow("Chameleon Twist: Recompiled", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1600, 960, flags);
#if defined(__gnu_linux__)
...
int main(int argc, char** argv) {
    ...
    printf("Found mods:\n");
    for (const auto& mod : recomp::mods::get_all_mod_details("ChameleonTwistJP")) {
