...
namespace {
constexpr const char* kLogTag = "CT1SDLProbe";
}

extern "C" __attribute__((visibility("default"))) void Java_io_github_chameleontwist1recomp_ChameleonTwist1SDLActivity_nativeSetAndroidSurfaceReady(
    JNIEnv*,
    jclass,
    jboolean ready) {
...
extern "C" __attribute__((visibility("default"))) void Java_io_github_chameleontwist1recomp_ChameleonTwist1SDLActivity_nativeSetAppAudioActive(
    JNIEnv*,
    jclass,
    jboolean active) {
...
extern "C" __attribute__((visibility("default"))) int SDL_main(int argc, char** argv) {
    ...
    SDL_Window* window = SDL_CreateWindow("Chameleon Twist: Recompiled SDL Probe",
